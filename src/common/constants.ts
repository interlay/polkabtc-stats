...
export const SYNC_DB_SCHEMA: boolean = (process.env.SYNC_DB_SCHEMA && process.env.SYNC_DB_SCHEMA === "1") || false

export const STATS_DEFAULT_PERPAGE = Number(process.env.STATS_DEFAULT_PERPAGE) || Number.MAX_SAFE_INTEGER;
